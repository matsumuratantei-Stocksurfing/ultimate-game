window.GAME_DATA = {
  "schemaVersion": 1,
  "updatedAt": "2026-07-28（W31定期実行に加え同日修正: W29週枠2件(1605/XOM)のlearning.typeを勝ちパターン候補→ノイズへ降格（Brier 0.740/0.755の確率乖離ラッキー勝ち。ユーザー確認済み）。W31定期実行: 週枠2件を新規追加（9201日本航空ロング/DALデルタ航空ロング、判定日7/31）。月枠2件(8306,V)・季枠2件(7011,AAPL)はオープン継続。米イラン戦闘停止でWTI-7.4%の82.67ドル、メモリ株暴落(CXMT上海IPO)、日経は一時-2,100円から終値-306円へ切り返す乱高下）",
  "rounds": [
  ...
  "positions": [
    ...
    {"id":"2026-W29-week-JP","roundId":"2026-W29","horizon":"week","market":"JP","direction":"ロング",
     ...
     "resolution":{
       ...
       "learning":{"type":"ノイズ","note":"【2026-07-28ユーザー確認のうえノイズ降格（旧:勝ちパターン候補）】結果は◎だがBrier 0.740は無知ライン0.667より悪い（bullに0.30しか配分せず的中＝確率予測としては外れ）。テーゼのメカニズム（原油93ドル台・エネルギー逆行高）は記録上機能したためthesisValidated=正しいは維持するが、確率乖離ラッキー勝ちであり、戦況依存・XOMと同一要因の日米ペアで実質N=1のため勝ちパターンへ昇格させない"},
    ...
    {"id":"2026-W29-week-US","roundId":"2026-W29","horizon":"week","market":"US","direction":"ロング",
     ...
     "resolution":{
       ...
       "thesisValidated":"正しい",
       "stopLossDiscipline":"該当なし",
       "learning":{"type":"ノイズ","note":"【2026-07-28ユーザー確認のうえノイズ降格（旧:勝ちパターン候補）】結果は◎だがBrier 0.755は無知ライン0.667より悪い（bullに0.30しか配分せず的中＝確率予測としては外れ）。チャットClaudeの指摘を受けた措置。メカニズム（エネルギー逆行高、6日で+8.57%対S&P500-2.17%）は記録上機能したためthesisValidated=正しいは維持するが、確率乖離ラッキー勝ち。INPEXと同一テーゼの日米ペアで実質N=1"},
